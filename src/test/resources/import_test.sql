...
insert into note_users (id,created,login_name,first_name,last_name,password,role,description,root_id,icon_url,status) values (2,CURRENT_TIMESTAMP,'luke','Luke','Feng','feng','Admin','cat lover',20,'/assets/images/m1.gif','Active');
insert into note_users (id,created,login_name,first_name,last_name,password,role,description,root_id,icon_url,status) values (3,CURRENT_TIMESTAMP,'lv','Peter','','vl','Standard','meat lover',30,'/assets/images/user.png','Active');
