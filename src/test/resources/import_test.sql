...
insert into note_users (id,login_name,first_name,last_name,password,role,description,root_id,icon_url) values (2,'luke','Luke','Feng','luke','Admin','cat lover',20,'/assets/images/m1.gif');
