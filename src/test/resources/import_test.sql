...
insert into note_users (id,login_name,first_name,last_name,password,role,description,root_id,icon_url) values (1,'zk','Oliver','Queen','zk','Admin','funny guy',1,'/assets/images/m2.gif');
insert into note_users (id,login_name,first_name,last_name,password,role,description,root_id,icon_url) values (2,'luke','Luke','Feng','still','Premium','cat lover',20,'/assets/images/m1.gif');
insert into note_users (id,login_name,first_name,last_name,password,role,description,root_id,icon_url) values (3,'Shado','Celina','Jade','Speedy','Standard','meat lover',30,'/assets/images/user.png');
